...
class SafetyStop(Node):
    ...
    def laser_callback(self, msg: LaserScan):
        ...
        # front_ranges = [
        #     int(len(msg.ranges)*0.45) : int(len(msg.ranges)*0.55)
        # ]
        ...
        if self.state != self.prev_state:
            # self.get_logger().info(f"Publishing safety_stop: {is_safety_stop.data}")
            is_safety_stop = Bool()
        ...
        # Markers will move with the frame of the LaserScan
